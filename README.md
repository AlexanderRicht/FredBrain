...
- It facilitates easy access to a wealth of economic data via the FRED API, directly storing it into a MySQL database for further analysis.
- The package experiments with integrating the OpenAI GPT framework, aiming to provide an ad-hoc GPT economist expert to support data interpretation and analysis, a feature we're excited about and hope to develop further.
